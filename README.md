...
[![Build Status](https://github.com/PhotogrammetryCourse/PhotogrammetryTasks2026/actions/workflows/cmake.yml/badge.svg?branch=task05&event=push)](https://github.com/PhotogrammetryCourse/PhotogrammetryTasks2026/actions/workflows/cmake.yml)

**Жесткий дедлайн**: вечер 20 апреля
...
4. Отправить **Pull-request** с названием```Task05 <ИмяНаРусском> <ФамилияНаРусском> <Аффиляция>```:

 - Скопируйте в описание [шаблон](https://raw.githubusercontent.com/PhotogrammetryCourse/PhotogrammetryTasks2026/task05/.github/pull_request_template.md)
 ...
 - Создайте PR
 - Затем дождавшись отработку Github Actions CI (около 15 минут) - скопируйте в описание PR вывод исполнения вашей программы **на CI** (через редактирование описания PR или комментарием, главное используйте пожалуйста спойлер для компактности)
